...
**Trạng thái:** Đã triển khai và kiểm chứng trên nhánh `feature/v0.10.0-insights-batch-sync` ngày 2026-07-24 (cargo test 32, frontend 66 test, `npm run build`, `check:code-size`). Chờ merge/phát hành.
